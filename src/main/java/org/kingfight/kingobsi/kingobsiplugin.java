...
import org.kingfight.kingobsi.handlers.ReloadCommand;
import org.kingfight.kingobsi.listener.WitherListener;
import org.kingfight.kingobsi.listener.Listener;
...
public class kingobsiplugin extends JavaPlugin {

    public FileConfiguration config;
    public int configVersion = 12;

    public static kingobsiplugin instance;
    ...
    private void registerCommands() {
        registerCommand("kingobsi", new ReloadCommand(), "kingobsidian");
    }
